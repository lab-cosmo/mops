...
void MOPS_EXPORT homogeneous_polynomial_evaluation(Tensor<scalar_t, 1> output,
...
extern template void homogeneous_polynomial_evaluation(
    Tensor<float, 1> output, Tensor<float, 2> tensor_a,
    Tensor<float, 1> tensor_c, Tensor<int32_t, 2> p);

extern template void homogeneous_polynomial_evaluation(
    Tensor<double, 1> output, Tensor<double, 2> tensor_a,
    Tensor<double, 1> tensor_c, Tensor<int32_t, 2> p);
