...
void MOPS_EXPORT sparse_accumulation_scatter_add_with_weights_vjp(
    ...
    Tensor<scalar_t, 3> W, Tensor<int, 1> indices_A, Tensor<int, 1> indices_W_1,
    Tensor<int, 1> indices_W_2, Tensor<int, 1> indices_output_1,
...
extern template void sparse_accumulation_scatter_add_with_weights_vjp(
    ...
    Tensor<double, 3> W, Tensor<int, 1> indices_A, Tensor<int, 1> indices_W_1,
    Tensor<int, 1> indices_W_2, Tensor<int, 1> indices_output_1,
    Tensor<int, 1> indices_output_2);
