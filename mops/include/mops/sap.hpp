...
void MOPS_EXPORT sparse_accumulation_of_products(
    Tensor<scalar_t, 2> output, Tensor<scalar_t, 2> tensor_a,
    Tensor<scalar_t, 2> tensor_b, Tensor<scalar_t, 1> tensor_c,
    Tensor<int32_t, 1> p_a, Tensor<int32_t, 1> p_b, Tensor<int32_t, 1> p_o);
...
extern template void sparse_accumulation_of_products(
    ...
    Tensor<float, 2> tensor_b, Tensor<float, 1> tensor_c,
    Tensor<int32_t, 1> p_a, Tensor<int32_t, 1> p_b, Tensor<int32_t, 1> p_o);

extern template void sparse_accumulation_of_products(
    Tensor<double, 2> output, Tensor<double, 2> tensor_a,
    Tensor<double, 2> tensor_b, Tensor<double, 1> tensor_c,
    Tensor<int32_t, 1> p_a, Tensor<int32_t, 1> p_b, Tensor<int32_t, 1> p_o);
