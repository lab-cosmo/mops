...
// forward declare for different types...
template float *align_array<float>(std::size_t n_elements, void *&ptr,
                                   const std::size_t alignment,
                                   std::size_t *space) noexcept;
template double *align_array<double>(std::size_t n_elements, void *&ptr,
                                     const std::size_t alignment,
                                     std::size_t *space) noexcept;
template int *align_array<int>(std::size_t n_elements, void *&ptr,
                               const std::size_t alignment,
                               std::size_t *space) noexcept;
template short *align_array<short>(std::size_t n_elements, void *&ptr,
                                   const std::size_t alignment,
                                   std::size_t *space) noexcept;
