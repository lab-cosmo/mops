        ...
        AT_DISPATCH_FLOATING_TYPES(
            ...
            [&]() {
                mops::sparse_accumulation_scatter_add_with_weights<scalar_t>(
                    ...
                    torch_to_mops_3d<scalar_t>(W),
                    torch_to_mops_1d<int32_t>(indices_A),
                    torch_to_mops_1d<int32_t>(indices_W_1),
                    torch_to_mops_1d<int32_t>(indices_W_2),
                    torch_to_mops_1d<int32_t>(indices_output_1),
                    torch_to_mops_1d<int32_t>(indices_output_2));
            });
    } else {
...
std::vector<torch::Tensor> SparseAccumulationScatterAddWithWeights::backward(
    ...
    return {grad_A,          grad_B,          torch::Tensor(), grad_W,
